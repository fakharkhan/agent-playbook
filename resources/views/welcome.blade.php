...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <a href="https://fakhar-khan.com" class="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-slate-300 transition-colors mb-8 group" rel="noopener noreferrer">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div class="flex-1 text-center lg:text-left">
                ...
                <p class="mt-4 text-base text-slate-500">
                    By <a href="https://fakhar-khan.com" class="text-slate-300 font-medium hover:text-white transition-colors underline decoration-slate-500 hover:decoration-slate-400 underline-offset-2" rel="noopener noreferrer">Fakhar Khan</a>
                </p>
